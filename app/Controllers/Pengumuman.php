...
class Pengumuman extends BaseController
{
    ...
    public function __construct()
    {
        ...
        $this->builder = $this->db->table('Pengumuman');
    }
...
$child[] = $value->status_id; 
            ...
            $child[] = "
                <center>
                    <a href='" . site_url('Pengumuman/edit/'.$value->id) . "' class='btn btn-sm btn-warning'>Edit</a>
    ...
    public function Index($edit = "")
    {
        if(isset($_POST['data'])){
            ...
            $data['form'] = $this->form();
            return redirect()->to('/Pengumuman'); // ubah disini
        }else{
            $data['form'] = $this->form();
    ...
    {
        $data['edit'] = $this->db->query("SELECT * FROM Pengumuman WHERE id = '$edit' ")->getRow();
        $data['form'] = $this->form();
        return view('admin/Pengumuman/index', $data);
    }
    ...
    public function simpan()
    {
        $data = $_POST['data'];
        $this->builder->insert($data);
        return redirect()->to('/form-Pengumuman');
    }

    public function formUpdate()
    {
        return view('admin/Pengumuman/update');
    }

    public function hapus()
    {
        $kode = $_POST['id'];
        $this->db->query("DELETE FROM Pengumuman WHERE id = '$kode' ");
        return redirect()->to('/Pengumuman'); // ubah disini
    }
}
