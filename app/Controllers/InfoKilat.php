...
class InfoKilat extends BaseController
{
    protected $db;
    protected $builder;
    ...
    public function __construct()
    {
        ...
        $this->builder = $this->db->table('InfoKilat');
    }
...
$child[] = $value->tanggal; 
            ...
            $child[] = "
                <center>
                    <a href='" . site_url('InfoKilat/edit/'.$value->id) . "' class='btn btn-sm btn-warning'>Edit</a>
    ...
    public function Index($edit = "")
    {
        if(isset($_POST['data'])){
            ...
            $data['form'] = $this->form();
            return redirect()->to('/InfoKilat'); // ubah disini
        }else{
            $data['form'] = $this->form();
            return view('admin/InfoKilat/index', $data);
        }
    }
    ...
    {
        $data['edit'] = $this->db->query("SELECT * FROM InfoKilat WHERE id = '$edit' ")->getRow();
        $data['form'] = $this->form();
        return view('admin/InfoKilat/index', $data);
    }
    ...
    public function simpan()
    {
        $data = $_POST['data'];
        $this->builder->insert($data);
        return redirect()->to('/form-InfoKilat');
    }

    public function formUpdate()
    {
        return view('admin/InfoKilat/update');
    }

    public function hapus()
    {
        $kode = $_POST['id'];
        $this->db->query("DELETE FROM InfoKilat WHERE id = '$kode' ");
        return redirect()->to('/InfoKilat'); // ubah disini
    }
}
