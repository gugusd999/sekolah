...
<?= $this->section('header') ?>
    <div class="page-title">
        <h4>
            ...
            <span class="text-semibold">Home</span> - SaranaPrasarana
...
<div class="container">
    <div class="row">
        <div class="col-sm-4">
            <?php if(isset($edit)) : ?>
                <?php
                    $form::start(site_url('SaranaPrasarana/update'));
                    $form::summernote();
...
<th>Action</th>
                    ...
                    $(document).ready(function(){
                        mytable = $("#mytable").DataTable({
                            ...
                            order: [],
                            ajax: {
                                "url"       : "<?= site_url('SaranaPrasarana/json')?>",
                                "type"      : "POST"
                            }
                        })
...
<div class="modal" id="hapusmodal">
  <div class="modal-dialog">
    <form action="<?= site_url('SaranaPrasarana/hapus')?>" method="post" enctype="">
